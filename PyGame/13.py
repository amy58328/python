...
def make_ball():
    ...
    ball.color_r = random.randrange(0,255)
    ball.color_g = random.randrange(0,255)
    ball.color_b = random.randrange(0,255)
...
def main():
    ...
    while not done:
        ...
        # Draw the balls
        for ball in ball_list:
            pygame.draw.circle(screen,(ball.color_r,ball.color_g,ball.color_b), [ball.x, ball.y], BALL_SIZE)
